...
<img width="454" height="32" alt="image" src="https://github.com/user-attachments/assets/e36ab0be-2ab3-4760-a23d-d9139a83f208" />  
<img width="358" height="35" alt="image" src="https://github.com/user-attachments/assets/437db74d-0cff-4b46-9d40-ac16e159a80a" />

### Добавлена инициализация логера  
<img width="731" height="133" alt="image" src="https://github.com/user-attachments/assets/c33215c6-b763-46ec-a47e-6357b85dc26f" />
...
# КТ4  
### Трассировка операций  (файлы с этим проектом расположены отдельно, так как это побочный квест(я уже прочитал последнюю Кт, оказывается это не просто побочный квест 0_0))
...
Добавлен обработчик исключений, для демонстрации операция remove при несуществующей задаче выбрасывает ошибку, вместо предупреждения  
<img width="2007" height="176" alt="image" src="https://github.com/user-attachments/assets/3dd26538-2eaa-4c25-bee6-bc74950dc5f6" />  
на скриншоте представлен исключительно лог ошибки, так как остальные части не менялись
